...
class Marcador():
    """Una clase para mostrar información sobre la puntuación."""
    ...
    def prep_alto_puntaje(self):
        ...
        # Muestra la puntuación más alta en la parte superior
    ...
    def prep_nivel(self):
        ...
        self.nivel_rect.right = self.puntaje_rect.right
        self.nivel_rect.top = self.puntaje_rect.bottom + 10

    def prep_naves(self):
        """Muestra cuántas naves quedan."""
        self.naves = Group()
        for nave_numero in range(self.estadisticas.naves_restantes):
